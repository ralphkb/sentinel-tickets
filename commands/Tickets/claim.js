...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        ...
        .setDefaultMemberPermissions(PermissionFlagsBits[config.commands.claim.permission])
    ...
    async execute(interaction) {
        ...
        if (claimStatus) {
            return interaction.reply({ content: `This ticket has already been claimed by <@!${claimUser}>`, ephemeral: true });
          }
